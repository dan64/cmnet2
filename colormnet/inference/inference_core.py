...
from colormnet.util.tensor_util import pad_divide_by, unpad
import torch
...
class InferenceCore:
    ...
    def step(self, image, mask=None, valid_labels=None, end=False):
        ...
        if need_segment:
            ...
            memory_value_short, _ = self.network.short_term_attn(key, self.last_ti_key, last_ti_value, None,
                                                                 key.shape[-2:])
    ...
    def step_AnyExemplar(self, image, msk_lll=None, msk_ab=None, valid_labels=None, end=False,
